...
public class DataRepository {
    ...
    private void initData() {
        ...
        umbbFaculties.add(new Faculty("Faculté des Hydrocarbures et de la Chimie (FHC)", R.drawable.img_umbb, fhcDepts));
        ...
        usthbFaculties.add(new Faculty("Faculté d'Informatique", R.drawable.img_info_usthb, usthbInfo));
        ...
        usthbFaculties.add(new Faculty("Faculté de Mathématiques", R.drawable.img_math_usthb, usthbMath));
        ...
        alger1Faculties.add(new Faculty("Faculté de Droit", R.drawable.img_droit, algerDroit));
